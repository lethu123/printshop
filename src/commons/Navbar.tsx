            ...
            <Container>
                ...
                <div className="hidden  xl:block">
                    ...
                    <div className="flex items-center gap-14 justify-center py-3 bg-white">
                        ...
                        <div>
                            <Link href={'/about-us'} className={`${styles.menu_single} ${path.includes('about-us') ? styles.active : ''} font-avo_bold text-[18px] py-3`}><Translations text='Về chúng tôi'/></Link>
                        </div>
                        <div>
                            <Link href={'/news'} className={`${styles.menu_single} ${path.includes('news') ? styles.active : ''} font-avo_bold text-[18px] py-3`}><Translations text='Tin tức'/></Link>
                        </div>
                        <div>
                            <Link href={'/contact'} className={`${styles.menu_single} ${path.includes('contact') ? styles.active : ''} font-avo_bold text-[18px] py-3`}><Translations text='Liên hệ'/></Link>
                        </div>
                    </div>
