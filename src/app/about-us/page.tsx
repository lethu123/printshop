                ...
                <Container>
                    ...
                    <div className="py-10 lg:pl-6">
                        ...
                        <p className="text-[18px]">
                            <span className="font-avo_bold font-medium text-white"><Translations text="2024-2028" />: </span>
            ...
            <section>
                ...
                <Container className="py-5">
                    ...
                    <div>
                        <p className='mb-3'>
                            <span>
                                <Translations text='text-about1' /> </span> <br />
                            <span><Translations text='text-about2' /></span>
                        </p>
                        <p className='mb-3'>
                            <span><Translations text='text-about3' /></span>
                        </p>
                        <p className='mb-3'>
                            <span><Translations text='text-about4' />
                            </span>
                        </p>
                        <p>
                            <span><Translations text='text-about5' /></span>
                        </p>
                    </div>
                </Container>
            </section>
