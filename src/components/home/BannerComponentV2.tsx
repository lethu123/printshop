        ...
        <Container>
          ...
          <div className="hidden xl:block">
            <div className="flex items-center gap-14 justify-center py-3">
              <Link
                href={"/"}
                className={`${styles.menu_single} ${styles.active} menu_single text-white text-[18px] py-3`}
              >
                Trang chủ
              </Link>
              <div className={`${styles.submenu} relative`}>
                <h3 className={`  text-white text-[18px] cursor-pointer py-3`}>
                  Sản phẩm{" "}
                  <i
                  ...
                  <div className=" max-w-md flex-auto overflow-hidden rounded bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                    <div className=" divide-x divide-gray-900/5 bg-gray-50 ">
                      <Link
                        ...
                        className="flex items-center px-8 text-nowrap  gap-x-2.5 p-3 font-semibold text-gray-900 hover:bg-gray-100"
                      >
                        Ấn Phẩm
                      </Link>
                      <Link
              ...
              <div>
                <Link
                  href={"/about-us"}
                  className={`${styles.menu_single} text-white text-[18px] py-3`}
                >
                  Về chúng tôi
                </Link>
              </div>
