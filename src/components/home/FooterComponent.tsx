      ...
      <div className="grid grid-cols-5 gap-5 items-stretch">
        <div className="col-span-3">
          ...
          <div className="flex items-center gap-40">
            ...
            <div className="flex rounded-full items-center gap-4 bg-white  p-[10px]">
              <div className="bg-black rounded-full w-[80px] h-[80px] p-3"><Image alt="" className="w-full h-full" src={logoBlack} /></div>
              <div>
                <div className="flex items-center gap-4">
                  <Image width={17} alt="" src={phone2} />
                  <p className="font-extrabold text-lg pe-1">Gọi cho chúng tôi</p>
                </div>
                <span className="text-[#F26311] text-lg font-bold">(+84) 913 927 471</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-2 flex items-end">
          <div className="flex gap-10 items-center ">
            ...
            <button className={`${styles.btn} text-[15.42px] py-3 px-10 border-0 outline-0 rounded-full font-semibold`}>Subcribe</button>
          </div> 
        </div>
      </div>
    </Container>
